          ...
          <div className="flight-info-popup-body-top-arrival">
            {additionalFlightData?.data.progress.status && (
              <div className="estimated-arrival">
                <p>{(additionalFlightData.data.progress.status.charAt(11) === '1' && additionalFlightData.data.progress.status.charAt(12) === ' ') || (additionalFlightData.data.progress.status.charAt(16) === '1' && additionalFlightData.data.progress.status.charAt(17) === ' ') ?
